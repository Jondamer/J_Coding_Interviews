...
public class RandomListNodeCloneSolution {
	...
	public static RandomListNode reconnectNodes(RandomListNode pHead) {
		...
		// System.out.println("此时的PNode到底是什么：" + PNode.next.next.value + "
		// pClonedHead: " + pClonedHead.next.value
		// + " pClonedNode到底是什么： " + pClonedNode.next.value);
		// 循环
		while (PNode != null) {
		...
		// System.out.println("pClonedNode的值是："+pClonedNode.value+"此时pClonedHead的值是："+pClonedHead.value);
		return pClonedHead;
	...
	public static void main(String[] args) {
		...
		// 测试方法三
		RandomListNode node = reconnectNodes(head);
		while (node != null) {
